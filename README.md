...
Repositório feito para arquivamento e divulgação da reclist PT-BR eCV-C, baseada na reclist "nova em folha" criada por [**fuka-oni**](https://github.com/fuka-oni), [**coffeemilk**](https://latinlechedotcom.carrd.co/) e [**oipatiu**](https://github.com/oipatiu), feito para sintetizadores de voz sampleados utilizando conotação BRAPA.<br/>
...
## Download
Você pode fazer o download [clicando aqui](https://github.com/maezono00/eCV-C-BRAPA-Reclist/blob/main/BRAPA_eCV.txt "Reclist")
